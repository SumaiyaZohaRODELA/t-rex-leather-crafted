    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 pt-32 pb-20">
        <div className="max-w-2xl">
          {/* Yellow Line */}
          <div className="w-16 h-px bg-yellow-yolk mb-8 animate-fade-up opacity-0" />
          
          {/* Small Text */}
          <p className="text-xs tracking-[0.4em] text-yellow-yolk uppercase mb-6 animate-fade-up opacity-0 stagger-1">
      ...
      <div className="absolute bottom-0 left-0 right-0 border-t border-border/30 bg-background/50 backdrop-blur-sm">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-3 divide-x divide-border/30">
            ...
            <div className="py-6 px-4 text-center">
              <p className="text-2xl md:text-3xl font-display font-semibold text-yellow-yolk">100%</p>
