      ...
      <div className="container mx-auto px-6 lg:px-12 py-20 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="w-12 h-px bg-yellow-yolk" />
          </div>
            ...
            <ul className="space-y-3">
              {footerLinks.navigation.map((item) => (
                <li key={item.name}>
                  <Link
                    to={item.path}
                    className="text-sm text-muted-foreground hover:text-yellow-yolk transition-colors"
                  >
                    {item.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <a href="tel:+8801712035733" className="text-sm text-foreground hover:text-yellow-yolk transition-colors">
                  +880 1712-035733
                </a>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-yellow-yolk">Md. Shamsuzzoha</p>
              </div>
            </div>
          </div>
        </div>
