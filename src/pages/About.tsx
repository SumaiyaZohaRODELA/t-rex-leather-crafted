            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-border/30">
              {values.map((value, index) => (
                <div key={index} className="bg-card p-10 text-center">
                  <value.icon className="w-8 h-8 text-yellow-yolk mx-auto mb-6" strokeWidth={1.5} />
          ...
          <div className="container mx-auto px-6 lg:px-12 relative z-10">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="bg-card border border-border/50 p-12">
                <div className="w-20 h-20 bg-secondary rounded-full mx-auto mb-6 flex items-center justify-center border border-yellow-yolk/30">
                  <span className="text-2xl font-display font-semibold text-yellow-yolk">MS</span>
                </div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-2">
                  Md. Shamsuzzoha
                </h3>
                <p className="text-yellow-yolk text-sm uppercase tracking-widest mb-6">Founder & Owner</p>
